...
ActiveRecord::Schema.define(:version => 20130712163207) do
  ...
  add_index "surveys", ["survey_code"], :name => "index_surveys_on_survey_code"
  ...
  add_index "users", ["customer"], :name => "index_users_on_customer"
